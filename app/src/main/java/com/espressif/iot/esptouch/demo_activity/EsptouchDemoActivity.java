...
public class EsptouchDemoActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esptouchdemo);
    ...
    private void onEsptoucResultAddedPerform(final IEsptouchResult result) {
        runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                String text = result.getBssid() + " 가 와이파이에 연결 되었습니다.";
    ...
    private static class EsptouchAsyncTask4 extends AsyncTask<byte[], Void, List<IEsptouchResult>> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog.setMessage("ESPtouch를 구성중입니다. 잠시만 기다려주세요...");
        ...
        protected void onPostExecute(List<IEsptouchResult> result) {
            ...
            if (!firstResult.isCancelled()) {
                ...
                if (firstResult.isSuc()) {
                    ...
                    mResultDialog.setMessage("Esptouch 실패");
                }
